...
router.get('/blocks', function (req, res, next) {
    async.series([
        function (callback) {
            db.getBlocks((req.query.page || 0), function (err, data) {
...
router.get('/batches', function (req, res, next) {
    async.series([
        function (callback) {
            db.getBatches((req.query.page || 0), function (err, data) {
...
router.get('/transactions', function (req, res, next) {
    async.series([
        function (callback) {
            db.getTransactions((req.query.page || 0), function (err, data) {
...
router.get('/transactions/:transaction_id', function (req, res, next) {
    async.series([
        function (callback) {
...
router.get('/transaction/:transaction_id/owner_picture', function (req, res, next) {
    async.series([
        function (callback) {
            db.getTransactionById(req.params.transaction_id, function (err, data) {
                if (!data[0])
...
router.get('/state', function (req, res, next) {
    async.series([
        function (callback) {
            db.getState((req.query.page || 0), function (err, data) {
...
router.get('/state/:state_address/owner_picture', function (req, res, next) {
    async.series([
        function (callback) {
